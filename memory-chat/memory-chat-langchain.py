...
class MemorySystem:
    ...
    def __init__(self, embeddings):
        ...
        self.memory_file = "memory_store.faiss"
        self.load_memory()
    ...
    def load_memory(self):
        try:
            if os.path.exists(self.memory_file):
                ...
                docs = [Document(page_content="Memory initialized", metadata={"timestamp": str(datetime.now())})]
    ...
    def save_memory(self):
        if self.vectorstore:
            self.vectorstore.save_local(self.memory_file)
